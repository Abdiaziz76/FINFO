...
const InputPrompt = () => {
  return (
    <div className="flex flex-col md:flex-row gap-2 items-center py-2 pr-8 mt-4 fixed bg-white bottom-2 md:max-w-[1050px] w-full">
        <div className="flex gap-2 items-center p-2 px-4 w-full md:w-3/4 border rounded-md">
...
const Response = () => {
  return (
    <div className="flex flex-col gap-2 mt-2 justify-start border rounded-md">
      <div className="flex items-center justify-between p-2">
        ...
        <div className="flex gap-2 text-blue-600 transition-colors">
      ...
      <div className="flex flex-col gap-2 p-1 px-3">
        <span className="text-start text-slate-500 font-medium">Sample response header, usually a summary of the question/request</span>
        <span className="text-start">sample response: Lorem ipsum dolor sit amet consectetur adipisicing elit. Est doloremque ad porro laudantium explicabo veritatis ipsa ut exercitationem adipisci dolor rem laborum, dolore excepturi eius in ratione assumenda quisquam obcaecati!</span>
