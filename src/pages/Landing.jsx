    ...
    <div className='dark:bg-slate-800 dark:text-white  w-full'>
      ...
      <nav className="bg-blue-500 dark:bg-black py-4 px-2">
        <div className="container mx-auto">
          <div className="flex justify-between items-center">
            <div className="text-white font-semibold text-2xl">FINFO</div>
            <div className='flex items-center justify-between gap-4'>
              <DarkModeSwitcher />
              <ul className="hidden md:flex space-x-6"> {/* Hide on screens smaller than medium (md) */}
      ...
      <section className="bg-gray-100 dark:bg-slate-600 py-16">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Your Trusted Financial Advisor</h1>
      ...
      <section className="py-16">
        <div className="container mx-auto">
          ...
          <p className="text-gray-600 dark:text-slate-200 mb-6">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut nunc eu ligula lacinia vehicula.
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold mb-4">Contact Us</h2>
          <p className="text-gray-600 dark:text-slate-200 mb-6">
