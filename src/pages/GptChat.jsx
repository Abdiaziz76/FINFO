    ...
    <div className="gpt h-full">
      <div className="h-full w-full bg-slate-100 dark:bg-slate-800">
        <div className="chat-container flex flex-col justify-between h-full py-2">
          <div className="message-list flex flex-col" ref={messageListRef}>
            {messages.map((message, i) => (
              ...
              >
                ...
                <div
                  ...
                  } ${message.direction === 'incoming' ? 'bg-blue-300 self-start w-full sm:w-2/3 rounded-r-md text-start' : 'bg-blue-200 self-end rounded-l-md'
                  } `}
                >
                  {message.message}
                </div>
          ...
          <>
            {isTyping ? <p className='text-blue-400 self-start animate-pulse rounded-md text-6xl text-center'>...</p> : ''}
            <div className="message-input  w-full sm:w-2/3 self-center mt-2  bottom-0">
              <form onSubmit={handleSend}>
                ...
                />
                <button type='submit' className='absolute right-4 top-4 ' onClick={handleSend}>
